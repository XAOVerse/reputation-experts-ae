...
export function ProblemStatementSection({
  heading,
  bodyLeft = "In 2026, over 85% of Dubai buyers and tenants check Google reviews before choosing a real estate brokerage or agent. Reputation directly drives revenue. A brokerage with a poor online reputation loses clients to the agency next door every single day, even when the listings, the locations and the agents are equally strong. We close that gap by removing damaging reviews that drag your rating down and generating a consistent stream of authentic multilingual 5-star reviews that strengthen trust and push your rating up.",
  bodyRight = "We also ensure your agency appears prominently when buyers and investors search on Google or ask ChatGPT for property recommendations in Dubai, including in Google AI Overviews. The result is more visibility in the markets that matter: GCC, UK, Russia, India, China and Europe. More qualified enquiries, more confirmed viewings, and more closed transactions. Dubai brokerages typically see a 30 to 50% increase in new client enquiries within the first three months.",
    ...
    >
      <div className="max-w-[1280px] mx-auto px-5 sm:px-6 lg:px-10">
        ...
        >
          {heading ?? (
            <>
              For many UK estate and letting businesses,{" "}
              <strong className="font-bold">
                poor reviews mean losing £5,000 to £50,000+ per year
              </strong>{" "}
              in lost revenue.
            </>
          )}
