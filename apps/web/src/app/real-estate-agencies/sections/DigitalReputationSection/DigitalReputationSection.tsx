...
export function DigitalReputationSection({
  ...
  description = "Our approach brings together review management, reputation building, Google AI Overview optimisation, ChatGPT recommendation positioning, and major online media publications - all in one integrated service built specifically for UK estate and letting businesses. Every strategy is shaped around how clients actually search for and choose their estate or letting agent online.",
  tags = DEFAULT_TAGS,
