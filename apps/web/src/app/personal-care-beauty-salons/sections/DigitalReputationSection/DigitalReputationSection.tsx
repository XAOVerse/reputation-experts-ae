...
export function DigitalReputationSection({
  ...
  description = "Our approach brings together review management, reputation building, Google AI Overview optimisation, ChatGPT recommendation positioning, and major online media publications, all in one integrated service built specifically for Dubai hair, beauty, barber, nail and personal care salons. Every strategy is shaped around how Dubai clients actually search for and choose a salon online.",
  tags = DEFAULT_TAGS,
