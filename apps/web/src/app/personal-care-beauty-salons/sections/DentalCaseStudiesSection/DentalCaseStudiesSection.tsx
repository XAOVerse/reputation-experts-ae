...
const CASE_STUDIES: CaseStudyItem[] = [
  {
    quote:
      "A private beauty salon came to us with a 3.6-star rating, several damaging fake reviews, and an online reputation that was undermining client trust. Within just under four months, we helped remove 8 fake and policy-violating reviews, implemented a consistent client review strategy, and increased the clinic’s rating to 4.7 stars. Booking enquiries rose by 40%, with the clinic benefiting from stronger trust, better visibility, and a much healthier flow of new enquiries.",
    avatar: { src: "/images/dental-case-study-1.png", alt: "Beauty Salon Case Study" },
    name: "Beauty Salon Case Study",
    title: "Reputation Recovery for a Beauty Salon in Midlands",
  },
  {
    quote:
