...
export const metadata: Metadata = {
  title: "Dubai Aesthetic & Cosmetic Clinics | Multilingual Reputation Management with 90-Day Money-Back Guarantee",
  description:
    "Dubai's only multilingual reputation team built for aesthetic and cosmetic clinics. We remove damaging reviews, generate authentic 5-star feedback in Arabic, English, Russian, Mandarin, German and French, and position your clinic at the top of Google and AI-driven search (Google AI Overviews and ChatGPT). Backed by a 90-day money-back guarantee.",
};
...
export default function AestheticClinicsPage() {
  return (
    <main>
      {/* 1. Hero */}
      <DentalHeroSection
        headline="Dubai’s only multilingual reputation team built for aesthetic and cosmetic clinics."
        ...
        imageAlt="Dubai aesthetic and cosmetic clinic reputation management"
      />
