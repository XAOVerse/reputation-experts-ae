...
export const metadata: Metadata = {
  title: "Dubai Bars, Lounges & Entertainment Venues | Multilingual Reputation Management with 90-Day Money-Back Guarantee",
  description:
    "Dubai's only multilingual reputation team built for bars, lounges, beach clubs, rooftops, cabarets, live venues, bowling alleys and entertainment destinations. We remove damaging reviews, generate authentic 5-star feedback in Arabic, English, Russian, Mandarin, German and French, and position your venue at the top of Google and AI-driven search (Google AI Overviews and ChatGPT). Backed by a 90-day money-back guarantee.",
};

export default function BarsLoungesEntertainmentPage() {
  return (
    <main>
      {/* 1. Hero */}
      <DentalHeroSection
        ...
        imageAlt="Dubai entertainment venue reputation management"
      />
