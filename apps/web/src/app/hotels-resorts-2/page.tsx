...
export const metadata: Metadata = {
  ...
  description:
    "Dubai's only multilingual reputation team built for hotels and resorts. Remove damaging reviews, generate authentic 5-star feedback in Arabic, English, Russian, Mandarin, German and French, and rank in Google AI Overviews and ChatGPT recommendations. Transparent pricing from AED 4,950/month. Backed by a 100% money-back guarantee if we don’t hit your written goals in 4 months.",
};
  ...
  return (
    <main>
      ...
      <DentalHeroSection
        ...
        subtitle="We remove damaging reviews, generate authentic 5-star feedback in Arabic, English, Russian, Mandarin, German and French, and position your property at the top of Google, Booking.com, TripAdvisor and AI-driven search — backed by a 100% money-back guarantee if we don’t hit your written goals in 4 months."
