...
export const metadata: Metadata = {
  ...
  description:
    "Dubai's only multilingual reputation team built for hotels and resorts. Remove damaging reviews, generate authentic 5-star feedback in Arabic, English, Russian, Mandarin, German and French, and rank in Google AI Overviews and ChatGPT recommendations. Transparent pricing from AED 4,950/month. Backed by a 90-day money-back guarantee — hit your goals or full refund, no questions.",
};
