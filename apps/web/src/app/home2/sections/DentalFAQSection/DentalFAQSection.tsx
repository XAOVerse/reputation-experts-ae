...
const DENTAL_FAQ = [
  ...
  {
    question: "How long does it take to see results for my business?",
    answer:
  ...
  {
    question: "How does Reputation Experts help businesses boost their bookings and increase sales?",
    answer:
