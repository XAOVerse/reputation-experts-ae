...
const DEFAULT_SERVICES: ServiceCard[] = [
  ...
  },
  {
    ...
    description:
      "Real-time alerts whenever your company is mentioned online. New review? We notify you. Negative article? We flag it. So you\u2019re never caught off guard again.",
  },
];
...
export function ReputationManagementSection({
  heading = "Reputation Management for Cleaning Services",
