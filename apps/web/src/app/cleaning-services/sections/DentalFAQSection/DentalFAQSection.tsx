...
const DENTAL_FAQ = [
  ...
  {
    question: "How long does it take to see results for my Dubai cleaning company?",
    answer:
  ...
  {
    question: "How does Google's AI Overview affect my Dubai cleaning company?",
    answer:
  ...
  {
    question: "How does Reputation Experts help my cleaning company boost jobs and increase revenue?",
    answer:
      "In Dubai's cleaning market, reputation directly drives revenue. 90% of residents and property managers check Google reviews before booking a cleaning company (unless existing clients). A company sitting at lower star ratings loses jobs to a competitor at a higher score every single day, even when the staff, the equipment and the pricing are equally strong. We close that gap by removing unfair reviews that drag your rating down, generating a consistent stream of new 5-star reviews that push it up, and ensuring your business appears prominently when potential customers search on Google, ask ChatGPT, or browse AI Overviews. The result is more clicks, more calls, and more customer enquiries, clients typically see a 30–50% increase in new customer enquiries within the first three months.",
  },
];
