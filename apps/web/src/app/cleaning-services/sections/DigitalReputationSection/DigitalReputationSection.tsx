...
export function DigitalReputationSection({
  ...
  description = "Our approach brings together review management, reputation building, Google AI Overview optimisation, ChatGPT recommendation positioning, and major online media publications, all in one integrated service built specifically for Dubai residential and commercial cleaning, deep cleaning, end-of-tenancy, maid service, carpet, window, disinfection, post-construction and AC duct cleaning companies. Every strategy is shaped around how Dubai residents and property managers actually search for and choose a cleaning company online.",
  tags = DEFAULT_TAGS,
