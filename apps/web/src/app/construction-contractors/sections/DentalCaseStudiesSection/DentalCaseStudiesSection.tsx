...
const CASE_STUDIES: CaseStudyItem[] = [
  {
    quote:
      "A private construction company came to us with a 3.6-star rating, several damaging fake reviews, and an online reputation that was undermining client trust. Within just under four months, we helped remove 8 fake and policy-violating reviews, implemented a consistent client review strategy, and increased the clinic’s rating to 4.7 stars. Project enquiries rose by 40%, with the clinic benefiting from stronger trust, better visibility, and a much healthier flow of new enquiries.",
    avatar: { src: "/images/dental-case-study-1.png", alt: "Construction Company Case Study" },
    name: "Construction Company Case Study",
    title: "Reputation Recovery for a Construction Company in Midlands",
  },
  {
    quote:
