...
const DENTAL_FAQ = [
  {
    ...
    answer:
      "We monitor your Google Business Profile around the clock, alongside how your workshop surfaces in Google AI Overviews and ChatGPT recommendations. The moment a harmful review appears, in any language, our team is alerted and we begin the removal process immediately. If a review cannot be taken down, we craft a professional response on your behalf in the right language, showing prospective drivers that your workshop takes feedback seriously. You're never caught off guard by a review again.",
  },
  {
    question: "How long does it take to see results for my Dubai garage or workshop?",
    answer:
  ...
  {
    question: "How does Google's AI Overview affect my Dubai garage or workshop?",
    answer:
      "Google's AI Overviews now pull together information from reviews, your website, and third-party sources into a single AI-generated answer at the top of the search results. When someone searches for terms like \"best garage Dubai\", \"best body shop Al Quoz\" or \"car AC repair Marina\", Google no longer just shows a list of websites; it increasingly highlights and recommends specific workshops. Reputation Experts strengthens your entire digital presence so your workshop is in a far better position to be trusted and recommended by Google's AI. This includes improving your review profile, increasing rating strength and review volume, optimising trust signals across your web presence, and building authority through high-quality third-party coverage. When your workshop is featured in trusted automotive, business and lifestyle publications, something we specialise in, it creates the kind of authority signals that naturally improve how your workshop is understood and recommended by Google AI Overviews, ChatGPT, and other AI-driven discovery platforms.",
  },
  {
  ...
  {
    question: "How does Reputation Experts help my workshop boost bookings and increase service revenue?",
    answer:
      "In Dubai's auto service market, reputation directly drives revenue. 90% of drivers check Google reviews before booking a workshop (unless existing clients). A workshop sitting at lower star ratings loses customers to a competitor at a higher score every single day, even when the technicians, the equipment and the pricing are equally strong. We close that gap by removing unfair reviews that drag your rating down, generating a consistent stream of new 5-star reviews that push it up, and ensuring your business appears prominently when potential customers search on Google, ask ChatGPT, or browse AI Overviews. The result is more clicks, more calls, and more customer enquiries, clients typically see a 30–50% increase in new customer enquiries within the first three months.",
  },
];
