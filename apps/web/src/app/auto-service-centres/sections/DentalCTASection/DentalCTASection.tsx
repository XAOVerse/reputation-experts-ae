    ...
    >
      <div className="max-w-[1280px] mx-auto">
        ...
        <div className="rounded-2xl bg-[#141414] px-8 sm:px-12 lg:px-16 py-14 lg:py-16">
          ...
          >
            Let&apos;s build a reputation your workshop deserves.
          </h2>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
            <div className="flex flex-row items-center gap-3 sm:contents">
              ...
              <Link
                href="/contact"
                className="inline-flex items-center justify-center px-6 py-2.5 rounded-full bg-[#e8503a] text-white text-[14px] font-medium hover:bg-[#d04330] transition-colors whitespace-nowrap"
              >
                Talk To Expert
              </Link>
            </div>
            ...
            <p className="text-white/35 text-[13px] sm:ml-4 leading-snug">
              Join Dubai garages, body shops, tyre centres and auto service workshops who trust us to protect and grow their online presence.
            </p>
          </div>
