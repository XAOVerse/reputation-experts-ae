...
const CASE_STUDIES: CaseStudyItem[] = [
  {
    quote:
      "A private home service company came to us with a 3.6-star rating, several damaging fake reviews, and an online reputation that was undermining customer trust. Within just under four months, we helped remove 8 fake and policy-violating reviews, implemented a consistent customer review strategy, and increased the clinic’s rating to 4.7 stars. Job bookings rose by 40%, with the clinic benefiting from stronger trust, better visibility, and a much healthier flow of new enquiries.",
    avatar: { src: "/images/dental-case-study-1.png", alt: "Home Service Company Case Study" },
    name: "Home Service Company Case Study",
    title: "Reputation Recovery for a Home Service Company in Midlands",
  },
  {
    quote:
