...
export function ProblemStatementSection({
  heading,
  bodyLeft = "In 2026, over 90% of Dubai residents check Google reviews before booking an AC technician, plumber, electrician, handyman, painter or pest control company. Reputation directly drives revenue. A home services company with a poor online reputation loses jobs to the company next door every single day, even when the technicians, the response times and the pricing are equally strong. We close that gap by removing damaging reviews that drag your rating down and generating a consistent stream of authentic multilingual 5-star reviews that strengthen trust and push your rating up.",
  bodyRight = "We also ensure your business appears prominently when residents search on Google or ask ChatGPT for home services recommendations in Dubai, including in Google AI Overviews. The result is more visibility in the neighbourhoods that matter: Marina, JBR, Downtown, Business Bay, Palm Jumeirah, Arabian Ranches, Damac Hills, JVC and beyond. More booked jobs, more repeat customers, and more referrals. Dubai home services companies typically see a 30 to 50% increase in new customer enquiries within the first three months.",
    ...
    >
      <div className="max-w-[1280px] mx-auto px-5 sm:px-6 lg:px-10">
        ...
        >
          {heading ?? (
            <>
              For many Dubai home services companies,{" "}
              <strong className="font-bold">
                poor reviews mean losing £2,000 to £100,000+ per year
              </strong>{" "}
              in lost revenue.
            </>
          )}
