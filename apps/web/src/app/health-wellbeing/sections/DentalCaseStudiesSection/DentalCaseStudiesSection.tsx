...
const CASE_STUDIES: CaseStudyItem[] = [
  {
    quote:
      "A private physiotherapy clinic came to us with a 3.6-star rating, several damaging fake reviews, and an online reputation that was undermining patient trust. Within just under four months, we helped remove 8 fake and policy-violating reviews, implemented a consistent patient review strategy, and increased the clinic’s rating to 4.7 stars. Patient bookings rose by 40%, with the clinic benefiting from stronger trust, better visibility, and a much healthier flow of new enquiries.",
    avatar: { src: "/images/dental-case-study-1.png", alt: "Physiotherapy Clinic Case Study" },
    name: "Physiotherapy Clinic Case Study",
    title: "Reputation Recovery for a Physiotherapy Clinic in Midlands",
  },
  {
    quote:
