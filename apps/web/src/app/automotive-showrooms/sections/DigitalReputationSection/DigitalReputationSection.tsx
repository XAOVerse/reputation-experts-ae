...
export function DigitalReputationSection({
  ...
  description = "Our approach brings together review management, reputation building, Google AI Overview optimisation, ChatGPT recommendation positioning, and major online media publications - all in one integrated service built specifically for Dubai auto showrooms, dealers, exporters and importers. Every strategy is shaped around how Dubai buyers and international clients actually search for and choose a showroom online.",
  tags = DEFAULT_TAGS,
