    ...
    >
      <div className="max-w-[1280px] mx-auto">
        ...
        <div className="rounded-2xl bg-[#141414] px-8 sm:px-12 lg:px-16 py-14 lg:py-16">
          ...
          >
            Let&apos;s build a reputation your showroom deserves.
          </h2>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
            ...
            <p className="text-white/35 text-[13px] sm:ml-4 leading-snug">
              Join Dubai auto showrooms, dealers, exporters and importers who trust us to protect and grow their online presence.
            </p>
          </div>
