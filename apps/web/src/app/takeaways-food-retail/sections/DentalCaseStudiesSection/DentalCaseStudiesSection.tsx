...
const CASE_STUDIES: CaseStudyItem[] = [
  {
    quote:
      "A private takeaway and food retail business came to us with a 3.6-star rating, several damaging fake reviews, and an online reputation that was undermining customer trust. Within just under four months, we helped remove 8 fake and policy-violating reviews, implemented a consistent customer review strategy, and increased the clinic’s rating to 4.7 stars. Customer bookings rose by 40%, with the clinic benefiting from stronger trust, better visibility, and a much healthier flow of new enquiries.",
    avatar: { src: "/images/dental-case-study-1.png", alt: "Takeaway and Food Retail Business Case Study" },
    name: "Takeaway and Food Retail Business Case Study",
    title: "Reputation Recovery for a Takeaway and Food Retail Business in Midlands",
  },
  {
    quote:
