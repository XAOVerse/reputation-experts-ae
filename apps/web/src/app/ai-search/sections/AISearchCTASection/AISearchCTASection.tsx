  ...
  return (
    ...
    >
      <div className="max-w-[1499px] mx-auto px-5 sm:px-6 lg:px-10 text-center">
        <h2
          className="text-[#0f0f0f] font-medium leading-[1.1] tracking-[-0.02em] mb-6 max-w-[920px] mx-auto"
          style={{ fontSize: "clamp(2rem, 4.2vw, 3.25rem)" }}
        >
          Be the answer AI gives when Dubai asks who is best.
        </h2>
        <p className="text-[#444] text-[16px] lg:text-[18px] leading-[1.6] max-w-[680px] mx-auto mb-10">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          ...
          <Link
            href="/contact"
            className="inline-flex items-center justify-center px-7 py-3.5 rounded-full border border-[#0f0f0f] text-[#0f0f0f] text-[15px] font-semibold tracking-[0.01em] hover:bg-[#0f0f0f] hover:text-white transition-colors"
          >
