      ...
      <section className="bg-[#f2f2f2] py-16 lg:py-24">
        <div className="max-w-[800px] mx-auto px-5 lg:px-8">
          ...
          <div className="space-y-8 text-[#444] text-[15px] leading-[1.75]">
            ...
            <div>
              <h2 className="text-[#0f0f0f] font-semibold text-[18px] mb-3">2. Description of Services</h2>
              <p>
            ...
            <div>
              <h2 className="text-[#0f0f0f] font-semibold text-[18px] mb-3">3. Eligibility and Account Responsibilities</h2>
              <p>
            ...
            <div>
              <h2 className="text-[#0f0f0f] font-semibold text-[18px] mb-3">4. Free Case Assessment</h2>
              <p>
            ...
            <div>
              <h2 className="text-[#0f0f0f] font-semibold text-[18px] mb-3">5. Fees, Payment, and Billing</h2>
              <p>
            ...
            <div>
              <h2 className="text-[#0f0f0f] font-semibold text-[18px] mb-3">7. Client Obligations and Representations</h2>
              <p>
            ...
            <div>
              <h2 className="text-[#0f0f0f] font-semibold text-[18px] mb-3">8. Confidentiality</h2>
              <p>
            ...
            <div>
              <h2 className="text-[#0f0f0f] font-semibold text-[18px] mb-3">10. Disclaimer of Warranties</h2>
              <p>
            ...
            <div>
              <h2 className="text-[#0f0f0f] font-semibold text-[18px] mb-3">13. Third-Party Platforms and Links</h2>
              <p>
            ...
            <div>
              <h2 className="text-[#0f0f0f] font-semibold text-[18px] mb-3">14. Termination</h2>
              <p>
            ...
            <div>
              <h2 className="text-[#0f0f0f] font-semibold text-[18px] mb-3">15. Governing Law and Dispute Resolution</h2>
              <p>
            ...
            <div>
              <h2 className="text-[#0f0f0f] font-semibold text-[18px] mb-3">16. Severability</h2>
              <p>
            ...
            <div>
              <h2 className="text-[#0f0f0f] font-semibold text-[18px] mb-3">17. Entire Agreement</h2>
              <p>
            ...
            <div>
              <h2 className="text-[#0f0f0f] font-semibold text-[18px] mb-3">18. Changes to These Terms</h2>
              <p>
            ...
            <div>
              <h2 className="text-[#0f0f0f] font-semibold text-[18px] mb-3">19. Contact Us</h2>
              <p>
