...
export function DigitalReputationSection({
  ...
  description = "Our approach brings together review management, reputation building, Google AI Overview optimisation, ChatGPT recommendation positioning, and major online media publications - all in one integrated service built specifically for UK restaurants and cafes. Every strategy is shaped around how diners actually search for and choose their restaurant online.",
  tags = DEFAULT_TAGS,
