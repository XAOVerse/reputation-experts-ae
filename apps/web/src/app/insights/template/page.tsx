...
const SECTIONS = [
  { id: "financial-industry-products", label: "Reputation in the trust economy" },
  { id: "legal-aspects", label: "Where reviews and the law meet" },
  { id: "cybersecurity", label: "Defending against fake reviews" },
  { id: "right-mindset", label: "The operator mindset that wins" },
...
export default function InsightsTemplatePage() {
  return (
    <main className="bg-white pt-[64px]">
      ...
      >
        {/* LEFT: hero image cell with its own bottom border */}
        <div
        ...
        <div
          ...
          className="flex flex-col gap-[59px]"
        >
          <h1
            className="text-black font-normal"
            style={{ fontSize: "59px", lineHeight: "67.85px", letterSpacing: "-0.01em" }}
          >
            How online reviews shape every booking, enquiry, and sale
          </h1>

          <div className="grid grid-cols-[4fr_12fr] h-[56px]">
            <div className="flex flex-col justify-center text-black" style={{ fontSize: "19.8px", lineHeight: "28px" }}>
              <p>Last updated: May 21,</p>
              <p>2026</p>
            </div>
            <div className="flex items-center gap-4">
              <div
                className="w-[50px] h-[50px] rounded-full overflow-hidden shrink-0 flex items-center justify-center"
                style={{ background: ORANGE + "1a" }}
                aria-hidden
              >
                <span style={{ color: ORANGE, fontWeight: 600, fontSize: 16 }}>RE</span>
              </div>
              <div className="flex flex-col text-black" style={{ fontSize: "20px", lineHeight: "28px" }}>
      ...
      {/* ─────────────────────────────────────────────────────
          BODY: two-column — TOC left (sticky), article right
      ...
      >
        ...
        <aside className="relative">
          ...
          >
            {/* Top spacer cell (matches Figma's 181px top gap) */}
            <div style={{ height: "181px", borderLeft: `1px solid ${BORDER}` }} />
            ...
            <div style={{ borderLeft: `1px solid ${BORDER}` }}>
              ...
              >
                <p className="text-black font-normal" style={{ fontSize: "30px", lineHeight: "39px" }}>
                  What&apos;s inside
                </p>
              </div>
            ...
            >
              <div className="flex items-end gap-[20px]">
                <span className="text-black" style={{ fontSize: "20px", lineHeight: "28px" }}>Share:</span>
                <a href="#" className="text-black underline underline-offset-[3px] decoration-1" style={{ fontSize: "20px", lineHeight: "28px" }}>Facebook</a>
                <a href="#" className="text-black underline underline-offset-[3px] decoration-1" style={{ fontSize: "19.1px", lineHeight: "28px" }}>LinkedIn</a>
                <a href="#" className="text-black underline underline-offset-[3px] decoration-1" style={{ fontSize: "20px", lineHeight: "28px" }}>X</a>
              </div>
            </div>
          </div>
        </aside>
          ...
          <div style={{ padding: "0 40px" }}>
            ...
            <div style={{ paddingTop: "60px", paddingBottom: "20px" }}>
              <p
                ...
                style={{ fontSize: "38px", lineHeight: "49.4px", letterSpacing: "-0.005em" }}
              >
            ...
            <p className="text-black" style={{ fontSize: "23.6px", lineHeight: "33.6px", paddingTop: "30px" }}>
            ...
            <p className="text-black" style={{ fontSize: "23.4px", lineHeight: "33.6px", paddingTop: "30px" }}>
            ...
            {/* H2 — section 1 */}
            <div style={{ paddingTop: "60px" }} id="financial-industry-products" className="scroll-mt-[100px]">
              <h2 className="font-normal" style={{ color: ORANGE, fontSize: "38px", lineHeight: "49.4px" }}>
            ...
            <p className="text-black" style={{ fontSize: "23.3px", lineHeight: "33.6px", paddingTop: "30px" }}>
            ...
            {/* H2 — section 2 */}
            <div style={{ paddingTop: "60px" }} id="legal-aspects" className="scroll-mt-[100px]">
              <h2 className="font-normal" style={{ color: ORANGE, fontSize: "38px", lineHeight: "49.4px" }}>
            ...
            <div
              style={{
                background: ORANGE,
                padding: "93px 40px 92px",
                marginTop: "76px",
                borderTop: `1px solid ${ORANGE}`,
              }}
            >
              <div style={{ display: "flex", flexDirection: "column", gap: "29px" }}>
                <h2 className="text-white font-normal" style={{ fontSize: "59px", lineHeight: "67.85px", letterSpacing: "-0.01em" }}>
                  Ready to take control of your online reputation?
                </h2>
                <p className="text-white" style={{ fontSize: "23.4px", lineHeight: "33.6px" }}>
                ...
                <div style={{ paddingTop: "34px" }}>
                  <Link
                    ...
                    style={{ fontSize: "30px", lineHeight: "39px" }}
                  >
                    Contact us
                  </Link>
                </div>
            ...
            {/* H2 — section 3 */}
            <div style={{ paddingTop: "76px" }} id="cybersecurity" className="scroll-mt-[100px]">
              <h2 className="font-normal" style={{ color: ORANGE, fontSize: "38px", lineHeight: "49.4px" }}>
            ...
            {/* H2 — section 4 */}
            <div style={{ paddingTop: "76px" }} id="right-mindset" className="scroll-mt-[100px]">
              <h2 className="font-normal" style={{ color: ORANGE, fontSize: "38px", lineHeight: "49.4px" }}>
                The operator mindset that wins
              </h2>
            </div>
            <p className="text-black" style={{ fontSize: "23.8px", lineHeight: "33.6px", paddingTop: "30px" }}>
            ...
            {/* H2 — Key takeaways (black, not orange) */}
            <div style={{ paddingTop: "76px" }} id="key-takeaways" className="scroll-mt-[100px]">
              <h2 className="text-black font-normal" style={{ fontSize: "38px", lineHeight: "49.4px" }}>
                Key takeaways
              </h2>
            </div>
            <p className="text-black" style={{ fontSize: "23.4px", lineHeight: "33.6px", paddingTop: "30px" }}>
            ...
            <ul style={{ paddingTop: "20px", paddingBottom: "16px" }} className="space-y-3">
              {[
                ...
                <li key={i} className="text-black flex gap-3" style={{ fontSize: "23.6px", lineHeight: "33.6px" }}>
                  <span aria-hidden style={{ paddingLeft: "1px" }}>•</span>
                  <span>{line}</span>
                </li>
              ))}
            </ul>
            <p className="text-black" style={{ fontSize: "23.8px", lineHeight: "33.6px", paddingTop: "30px", paddingBottom: "80px" }}>
