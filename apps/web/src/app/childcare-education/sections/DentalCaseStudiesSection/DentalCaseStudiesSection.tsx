...
const CASE_STUDIES: CaseStudyItem[] = [
  {
    quote:
      "A private childcare provider came to us with a 3.6-star rating, several damaging fake reviews, and an online reputation that was undermining parent trust. Within just under four months, we helped remove 8 fake and policy-violating reviews, implemented a consistent parent review strategy, and increased the clinic’s rating to 4.7 stars. Enrolment enquiries rose by 40%, with the clinic benefiting from stronger trust, better visibility, and a much healthier flow of new enquiries.",
    avatar: { src: "/images/dental-case-study-1.png", alt: "Childcare Provider Case Study" },
    name: "Childcare Provider Case Study",
    title: "Reputation Recovery for a Childcare Provider in Midlands",
  },
  {
    quote:
