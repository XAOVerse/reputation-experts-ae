...
export const metadata: Metadata = {
  title: "Dubai Fit-Out Contractors | Multilingual Reputation Management with 90-Day Money-Back Guarantee",
  description:
    "Dubai's only multilingual reputation team built for fit-out contractors, interior contracting firms, MEP and joinery specialists. We remove damaging reviews, generate authentic 5-star feedback in Arabic, English, Russian, Mandarin, German and French, and position your firm at the top of Google and AI-driven search (Google AI Overviews and ChatGPT). Backed by a 90-day money-back guarantee.",
};

export default function FitOutContractorsPage() {
  return (
    <main>
      {/* 1. Hero */}
      <DentalHeroSection
