...
export function ProblemStatementSection({
  heading,
  bodyLeft = "The shift from blue links to AI answers has happened faster than any change in search since Google launched. In Dubai it is more pronounced, because most queries are commercial: where to eat, where to stay, which clinic, which broker, which workshop. AI search engines respond by naming two or three businesses, citing their sources, and letting the searcher skip the rest of the page. The businesses named are the ones whose review profile, language coverage, press authority and structured data all say the same thing in the same direction. When those signals disagree, the AI either guesses or omits the business entirely.",
  bodyRight = "We treat your AI search positioning as an engineering problem. We audit every signal the major AI engines weight, identify where your business is being underread or skipped, rebuild the review depth and multilingual coverage that anchor your authority, and secure the third-party press citations that give the AI a trustworthy source to quote. The goal is simple: when a customer in Dubai, London, Moscow, Mumbai or Shanghai asks an AI for the best in your category, the answer names you.",
    ...
    >
      <div className="max-w-[1280px] mx-auto px-5 sm:px-6 lg:px-10">
        ...
        >
          {heading ?? (
            <>
              For many Dubai businesses,{" "}
              <strong className="font-bold">
                poor reviews mean losing AED 250,000 to AED 2.5 million+ per year
              </strong>{" "}
              in cancelled bookings and lost direct revenue.
            </>
          )}
        </h2>
