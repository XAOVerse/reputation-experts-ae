...
export const metadata: Metadata = {
  title: "Dubai Fitness, Spa & Wellness | Multilingual Reputation Management with 90-Day Money-Back Guarantee",
  description:
    "Dubai's only multilingual reputation team built for gyms, boutique studios, yoga and pilates studios, day spas, wellness centres and personal trainers. We remove damaging reviews, generate authentic 5-star feedback in Arabic, English, Russian, Mandarin, German and French, and position your business at the top of Google and AI-driven search (Google AI Overviews and ChatGPT). Backed by a 90-day money-back guarantee.",
};

export default function FitnessSpaWellnessPage() {
  return (
    <main>
      {/* 1. Hero */}
      <DentalHeroSection
