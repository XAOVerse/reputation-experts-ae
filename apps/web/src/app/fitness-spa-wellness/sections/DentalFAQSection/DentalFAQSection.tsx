...
const DENTAL_FAQ = [
  {
    ...
    answer:
      "We monitor your Google Business Profile around the clock, alongside how your business surfaces in Google AI Overviews and ChatGPT recommendations. The moment a harmful review appears, in any language, our team is alerted and we begin the removal process immediately. If a review cannot be taken down, we craft a professional response on your behalf in the right language, showing prospective members that your studio takes feedback seriously. You're never caught off guard by a review again.",
  },
  {
    question: "How long does it take to see results for my Dubai fitness, spa or wellness business?",
    answer:
  ...
  {
    question: "How does Google's AI Overview affect my fitness, spa or wellness business?",
    answer:
      "Google's AI Overviews now pull together information from reviews, your website, and third-party sources into a single AI-generated answer at the top of the search results. When someone searches for terms like \"best gym near me\", Google no longer just shows a list of websites; it increasingly highlights and recommends specific businesss. Reputation Experts strengthens your entire digital presence so your business is in a far better position to be trusted and recommended by Google's AI. This includes improving your review profile, increasing rating strength and review volume, optimising trust signals across your web presence, and building authority through high-quality third-party coverage. When your fitness and wellness business is featured in trusted media and reputable publications, something we specialise in, it creates the kind of authority signals that naturally improve how your business is understood and recommended by Google AI Overviews, ChatGPT, and other AI-driven discovery platforms.",
  },
  {
    question: "How does Reputation Experts build a strong online reputation for my business?",
    answer:
      "We work across three phases. First, we clean up, removing policy-violating reviews, suppressing negative search results, and fixing gaps in your Google Business Profile. Second, we strengthen, building a steady flow of genuine 5-star reviews from your existing members using follow-up systems timed around bookings, and publishing authoritative content that positions your business as a trusted name online. Third, we establish long-term authority, securing press coverage, optimising for Google AI Overviews and ChatGPT recommendations, and providing ongoing monitoring so your reputation stays protected month after month.",
  },
  {
    question: "How does Reputation Experts help my fitness or wellness business boost new-member trials and increase revenue?",
    answer:
      "In Dubai's fitness and wellness market, reputation directly drives revenue. 85% of members check Google reviews before booking a trial (unless existing clients). A studio sitting at lower star ratings loses members to a competitor at a higher score every single day, even when the trainers, the equipment and the location are equally strong. We close that gap by removing unfair reviews that drag your rating down, generating a consistent stream of new 5-star reviews that push it up, and ensuring your business appears prominently when potential members search on Google, ask ChatGPT, or browse AI Overviews. The result is more clicks, more calls, and more member enquiries, clients typically see a 30–50% increase in new member enquiries within the first three months.",
  },
];
