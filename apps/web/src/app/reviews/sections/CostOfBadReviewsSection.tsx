...
const COSTS = [
  ...
  },
  {
    ...
    body: "A prospect sees your ad, clicks the location, sees a thin or negative review profile, and chooses a competitor. You paid for the impression, the click and the bid premium, and the conversion went next door. Every marketing dirham past that point is subsidising a leaky funnel.",
  },
  {
  ...
  return (
    ...
    >
      <div className="max-w-[1280px] mx-auto px-5 sm:px-6 lg:px-10">
        ...
        {/* 4 items — orange uppercase tracked titles, matches Always-on Protection */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
          {COSTS.map((c) => (
            <div key={c.title} className="border-t border-[#e5e5e5] pt-6">
