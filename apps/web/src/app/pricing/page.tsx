...
export const metadata: Metadata = {
  ...
  description:
    "Five subscription tiers from AED 995/mo to AED 6,995/mo, each with a written 90-day score guarantee. Review removals are no-win, no-fee — no removal, no payment. No setup fees.",
};
