  ...
  return (
    ...
    >
      <div className="max-w-[1280px] mx-auto px-5 sm:px-6 lg:px-10">
        ...
        <p className="text-[#555] text-[15px] sm:text-[16px] leading-[1.7] mb-10 lg:mb-14 max-w-[820px]">
          ...
          or the work continues at no extra cost until we do. This applies on
          every tier, from Growth to Enterprise.
        </p>
